export const menuRankProduct = [
  {id:1, title:"아우터", link:"/men/man-outer", rightMainData:[
      {
  ...
  {id:2, title:"펜츠", link:"/women/women-pants", rightMainData:[
      {
  ...
  {id:3, title:"가방", link:"/sundries/sundries-man-bag", rightMainData:[
      {
        code:"P4W4D3202GUB1",
  ...
  {id:4, title:"신발", link:"/men/man-shoes", rightMainData:[
      {
        code:"P4WYM0134401W",
    ...
    ], rank:[
      {
        ...
        img: '/images/products/T52F6ASZ330WT1BDS/thumbnail.jpg',
        brand: 'TOMMY SHOES',
        title:"엘레트라 페니 레더 로퍼"
      }
  ]},
  {id:5, title:"스커트", link:"/women/women-skirt", rightMainData:[
      {
